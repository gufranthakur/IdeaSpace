...
class CanvasDrawing:
    ...
    def draw_point(self, x, y):
        ...
        if self.prev_point is not None:
            # Draw thick line with anti-aliasing for smoothness
            if self.is_erasing:
    ...
    def handle_ui_point(self, x, y):
        """Handle interaction with unified UI"""
    ...
    def _detect_and_correct_shape(self):
        """Simple shape smoothing - only lines and circles"""
