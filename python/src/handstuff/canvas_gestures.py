...
class CanvasGestureDetector:
    ...
    def detect_canvas_gestures(self, lms, img):
        ...
        thumb_extended = thumb_dist_from_palm > 80  # Thumb extended from palm

        # Check other fingers VERY curled (close to palm)
        ...
        # Priority 2: Draw mode - ONLY index up
        ...
        # Priority 3: Erase mode - Open hand (4-5 fingers)
